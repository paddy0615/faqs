...
myapp.directive('leftDirective', function() {
    var templateHtml = " <div class=\"col-sm-3 col-md-2 sidebar\">" +
        ...
        "                <li class=\"languagePage\"><a href=\"/faqs/admin/language\">Language Maintenance</a></li>\n" +
        "                <li class=\"categoryPage\"><a href=\"/faqs/admin/category\">Category Maintenance</a></li>\n" +
        "                <li class=\"detailedPage\"><a href=\"/faqs/admin/detailed\">FAQ</a></li>\n" +
        "            </ul></div>";
    return {
        restrict: 'E',
